...
var parseTests = []parseTest{
	...
	{
		"foo()",
		&ast.CallNode{Function: &ast.IdentifierNode{Value: "foo", NodeType: ast.NodeIdentifier},
			Arguments: []ast.Node{},
	...
	},
	{
		"foo(baz())",
		&ast.CallNode{Function: &ast.IdentifierNode{Value: "foo", NodeType: ast.NodeIdentifier},
			Arguments: []ast.Node{&ast.CallNode{Function: &ast.IdentifierNode{Value: "baz", NodeType: ast.NodeIdentifier},
				Arguments: []ast.Node{},
				NodeType:  ast.NodeCall}},
			NodeType: ast.NodeCall,
		},
